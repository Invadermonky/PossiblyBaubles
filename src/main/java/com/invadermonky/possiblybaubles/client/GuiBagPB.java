...
public class GuiBagPB extends GuiContainer {
    ...
    private final ContainerBagPB container;
    private final boolean isVoid;
    private FilterSettingsGui filter;
    private GuiButton buttonAutoInsert;

    public GuiBagPB(ItemStack sack, InventoryPlayer inventory, boolean isVoid) {
        this(isVoid, new ContainerBagPB(sack, inventory, isVoid));
    }

    private GuiBagPB(boolean isVoid, ContainerBagPB container) {
        super(container);
        this.xSize = 176;
        this.ySize = 176;
        this.isVoid = isVoid;
    ...
    public void drawGuiContainerForegroundLayer(int x, int y) {
        AssetUtil.displayNameString(this.fontRenderer, this.xSize, -10, StringUtil.localize("container.actuallyadditions." + (this.isVoid ? "voidBag" : "bag") + ".name"));
    }
